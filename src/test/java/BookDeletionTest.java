...
public class BookDeletionTest {
    ...
    public void DeleteBookSuccessfullyTest() {
        Book bookToDelete = new Book("Frankenstein", "0-2456-4821-5", "Mary Shelley", "B1");
        Book book = new Book("Dune", "0-3756-9921-4", "Frank Herbert", "A4");
    ...
    public void DeleteNotFoundBookTest() {
        Book book1 = new Book("The Lord of the Rings", "0-4956-9661-9", "J. R. R. Tolkien", "B3");
        Book book2 = new Book("The Adventures of Sherlock Holmes", "0-1250-9821-7", "Arthur Conan Doyle", "A1");
    ...
    public void DeleteBookWithBorrowedBookCopiesTest() {
        ...
        Book book = new Book("The Great Gatsby", "0-4545-3215-8", "F. Scott Fitzgerald", "A7");
